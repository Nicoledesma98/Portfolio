...
const Project = () => {
  return (
    <Container fluid className='project'>
      <Row>
        <Col>
        <h2 className='tittlesproject'>Proyectos</h2>
        </Col>
      </Row>
      <Row>
        <Col>
      ...
      <Card className='cardpr'>
        ...
        <Card.Footer className='buttoncard'>
          ...
          <a href='https://nicoledesma98.github.io/PorLosPelos-comision24500/index.html' className='pbtn'>Web</a>
        </Card.Footer>
      </Card>
      <Card className='cardpr'>
        ...
        <Card.Footer className='buttoncard'>
          ...
          <a href='https://stupendous-dodol-20b99e.netlify.app/' className='pbtn'>Web</a>
        </Card.Footer>
      </Card>
      <Card className='cardpr'>
        ...
        <Card.Footer className='buttoncard'>
          ...
          <a href='https://pet-ecommerce-ochre.vercel.app/' className='pbtn'>Web</a>
        </Card.Footer>
      </Card>
    </CardGroup>
        </Col>
